...
import org.quifft.audioread.PCMSamplesReader;
...
public class QuiFFT {
    ...
    private final FFTParameters fftParameters = new FFTParameters();
    ...
    /**
     * Constructs a QuiFFT instance from raw PCM samples.
     *
     * @param samples    array of 16-bit PCM samples
     * @param sampleRate sampling rate of provided samples
     */
    public QuiFFT(short[] samples, float sampleRate) {
        this.audioReader = new PCMSamplesReader(samples, sampleRate);
    }
